# Teaching Module: Basic Formal Ontology (BFO) Basics

## Learning Objectives

Students will:

- Distinguish between continuants and occurrents in BFO.
- Understand dependent continuants (generically, specifically, realisable, relational).
- Recognise how BFO categories underpin the SOoL structural model.
...
- **Process (Occurrent):** An unfolding event or action (e.g., a trial).  

## Relevance to SOoL

SOoL uses BFO categories to type each MLC link.  Understanding BFO ensures that the ontology is internally consistent and interoperable with other domain ontologies.  For example:

- **Authority** → Generically dependent continuant.
- **Role** → Specifically dependent continuant.
- **Authorised Process** → Process (Occurrent).

## Activities

- **Categorise Entities:** Students classify a list of legal concepts (e.g., ‘judge’, ‘licence’, ‘trial’, ‘law’) into BFO categories.
- **Discussion:** How does BFO help avoid category mistakes (e.g., treating a process as an object)?
